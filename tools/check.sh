...
echo "[29/31] 登录门冒烟（带 ANJIAN_USER 的实例）"
PORT2=39771
...
echo "[30/31] DSH sidecar 设置白名单（enabled 门 + baseURL 允许域策略 + apiKeyEnv 保留名）"
node tools/test-agent-config.js

echo "[31/31] DSH sidecar supervisor（门禁红线 + turn/worker 生命周期回归）"
